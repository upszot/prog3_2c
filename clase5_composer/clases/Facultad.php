...
class Facultad implements  IApiUsable{
    ...
    {//request => 
        ...
        $array=$request->getParsedBody();
         ...
         self::AltaUsuario( $array['legajo'], $array['email'], $array['nombre'],  $array['clave'],$arrayFotos['foto1'], $arrayFotos['foto2'] );
